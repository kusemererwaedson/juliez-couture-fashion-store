...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>juliez-couture-fashion</title>
      ...
      <section class="banner_main">
         <div class="container">
            <div class="row">
               <div class="col-md-8">
                  <div class="text-bg">
                     <h1> <span class="blodark"> juliez-couture-fashion-store </span> <br>Trands 2022</h1>
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                     <p>© 2022 All Rights Reserved. Design by<a href="https://app.campusweekly.info/"> Lukard Technologies</a></p>
                     </div>
                  </div>
               </div>
            </div>
